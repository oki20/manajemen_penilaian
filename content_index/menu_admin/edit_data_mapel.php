...
<?php
	...
	$sql = "SELECT * FROM tabel_mapel WHERE id_mapel=$id";
...
<?php
	...
	if(isset($_POST['update'])){
		...
		$sql = "UPDATE tabel_mapel
				SET mata_pelajaran='$mata_pelajaran', tingkatan_kelas='$tingkatan_kelas', kategori_kelas='$kategori_kelas', pengajar='$pengajar'
				WHERE id_mapel=$id";
		$query = mysqli_query($koneksi, $sql);
				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Edit Data Mata Pelajaran</a>
							</li>
						</ul>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
                                    <div class="col-lg-12">
                                        <form method="POST" action="edit_data_mapel.php">
											<fieldset>
											<div class="card-mb-8">
												<div class="card mb-4">
													<div class="card-body">
														...
														<div class="row">
															...
															<div class="col-sm-7">
																...
																style="border:none " id="mata_pelajaran" 
																name="mata_pelajaran"  value="<?php echo $mapel['mata_pelajaran'];?>"
																type="text" required="">
															</div>
														</div>
														<hr>
														...
														<div class="row">
															...
															<div class="form-group form-floating-label col-sm-7">
																	<select name="tingkatan_kelas" class="form-control input-solid" id="selectFloatingLabel2" required="">
																		<option value="<?php echo $mapel['tingkatan_kelas']?>"><?php echo $mapel['tingkatan_kelas']?></option>
																		<?php
																			$data1 = mysqli_query($koneksi,"SELECT * from tabel_kelas");
																			while($kelas = mysqli_fetch_array($data1))
																			{ 
																				if ($mapel['tingkatan_kelas']==$kelas['tingkatan_kelas']) {
																					$select="selected";
																				}else{
																					$select="";
																					}
														...
														<div class="row">
															...
															<div class="form-group form-floating-label col-sm-7">
																	<select name="kategori_kelas" class="form-control input-solid" id="selectFloatingLabel2" required="">
																		<option value="<?php echo $mapel['kategori_kelas']?>"><?php echo $mapel['kategori_kelas']?></option>
																		<?php
																			$data1 = mysqli_query($koneksi,"SELECT * from tabel_kategori");
																			while($kategori = mysqli_fetch_array($data1))
																			{ 
																				if ($mapel['kategori_kelas']==$kategori['kategori_kelas']) {
																					$select="selected";
																				}else{
																					$select="";
																					}
														...
														<div class="row">
															...
															<div class="form-group form-floating-label col-sm-7">
																	<select name="pengajar" class="form-control input-solid" id="selectFloatingLabel2" required="">
																		<option value="<?php echo $mapel['pengajar']?>"><?php echo $mapel['pengajar']?></option>
																		<?php
																			$data1 = mysqli_query($koneksi,"SELECT * from user WHERE role_user = 'guru' ");
																			while($pengajar = mysqli_fetch_array($data1))
																			{ 
																				if ($mapel['pengajar']==$pengajar['nama_user']) {
																					$select="selected";
																				}else{
																					$select="";
																					}
																					echo "<option $select>".$pengajar['nama_user']."</option>";	
																				?>
