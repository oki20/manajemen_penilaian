...
<?php
	...
	if(isset($_POST['update'])){
		...
		$sql = "UPDATE tabel_kelas SET tingkatan_kelas='$tingkatan_kelas' WHERE id_kelas=$id";
		$query = mysqli_query($koneksi, $sql);
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
                                    <div class="col-lg-12">
                                        <form method="POST" action="edit_data_kelas.php">
											<fieldset>
											<div class="card-mb-8">
												<div class="card mb-4">
													<div class="card-body">
														<div class="row">
															...
															<div class="col-sm-7">
																<input class="text-muted mb-0 form-control input-solid" 
																		style="border:none " id="tingkatan_kelas" 
																		name="tingkatan_kelas"  value="<?php echo $kelas['tingkatan_kelas'];?>"
																		type="text" required="">
															</div>
														</div>
														<hr>
