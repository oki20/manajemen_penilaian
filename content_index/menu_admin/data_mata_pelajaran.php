...
<?php 
	...
	if(isset($_POST['simpan'])){
		...
		$sql = "INSERT INTO tabel_mapel (mata_pelajaran, tingkatan_kelas, kategori_kelas, pengajar) 
                VALUE ('$mata_pelajaran', '$tingkatan_kelas', '$kategori_kelas', '$pengajar' )";
...
<?php
    ...
    // buat query hapus
    $delete = "DELETE FROM tabel_mapel WHERE id_mapel=$id";
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<p class="small">Lengkapi Form dibawah ini :</p>
													<form method="POST" action="data_mata_pelajaran.php">
														<div class="form-group form-floating-label">
															<div class="form-group form-floating-label">
																<input id="mata_pelajaran" name="mata_pelajaran" type="text" class="form-control input-solid" required="">
																<label for="mata_pelajaran" class="placeholder">Input Nama Mata Pelajaran</label>
															</div>	
														</div>
														...
														<div class="form-group form-floating-label">
															<select class="form-control input-solid" name="kategori_kelas" required="">
																<option id="kategori_kelas" name="kategori_kelas" value="">Pilih Kategori Kelas</option>
																<?php
																	include('../../koneksi.php');
														...
														<div class="form-group form-floating-label">
															<select class="form-control input-solid" name="pengajar" required="">
																<option id="pengajar" name="pengajar" value="">Pilih Guru</option>
																<?php
																	include('../../koneksi.php');
																	$data2 = mysqli_query($koneksi,"SELECT * from user where role_user = 'guru'");
																	while($guru = mysqli_fetch_array($data2))
																	{ ?>
																		<option id="pengajar" name="pengajar" value="<?php echo $guru['nama_user'];?>"><?php echo $guru['nama_user'];?></option>
																		<label for="pengajar" class="placeholder">Pilih Tingkatan Kelas</label>
																<?php } ?>	
															</select>
														</div>
										...
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
												...
												<?php 
													...
													$data = mysqli_query($koneksi,"SELECT * from tabel_mapel ORDER BY id_mapel ASC");
													...
													{ ?>
														<tr>
															...
															<td><?php echo $row['kategori_kelas']; ?></td>
															<td><?php echo $row['pengajar']; ?></td>
															<td>
																<div class="form-button-action">
																	<a href="edit_data_mapel.php?id_mapel=<?=$row['id_mapel']?>" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task">
																		<i class="fa fa-edit"></i>
																	</a>
																	<a href="data_mata_pelajaran.php?id_mapel=<?=$row['id_mapel']?>" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Remove">
