...
<?php
	...
	if(isset($_POST['update'])){
		...
		$sql = "UPDATE tabel_kategori SET kategori_kelas='$kategori_kelas' WHERE id_kategori=$id";
		$query = mysqli_query($koneksi, $sql);
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">Edit Keategori</h4>
									</div>
								</div>
								<div class="card-body">
                                    <div class="col-lg-12">
                                        <form method="POST" action="edit_data_kategori.php">
											<fieldset>
											<div class="card-mb-8">
												<div class="card mb-4">
													<div class="card-body">
														<div class="row">
															...
															<div class="col-sm-7">
																<input class="text-muted mb-0 form-control input-solid" 
																		style="border:none " id="kategori_kelas" 
																		name="kategori_kelas"  value="<?php echo $kategori['kategori_kelas'];?>"
																		type="text" required="">
															</div>
														</div>
														<hr>
